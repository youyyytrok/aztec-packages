...
// // Define the custom type name function
// template <typename T> std::string GetTypeName();

// template <> std::string GetTypeName<bb::UltraFlavor>()
// {
//     return "UltraFlavor";
// }
// template <> std::string GetTypeName<bb::UltraFlavorWithZK>()
// {
//     return "UltraFlavorWithZK";
// }

using namespace bb;

// template <typename T> class SumcheckTestsTypeNames {
//   public:
//     static std::string GetName(int) { return GetTypeName<T>(); }
// };

namespace {
// Custom Type Names Generator
...
>>>>>>> 0ddf39290e40acc1b5429c61417f949799884519
    ...
    // void test_libra_polynomials_normalization()
    // {
    //     // using ZKSumcheckSetupData = SumcheckProverRound<Flavor>::ZKSumcheckSetupData;
    //     size_t multivariate_d(5);
    //     const size_t BATCHED_RELATION_PARTIAL_LENGTH = Flavor::BATCHED_RELATION_PARTIAL_LENGTH;
    //     // std::vector<bb::Univariate<FF, BATCHED_RELATION_PARTIAL_LENGTH>> libra_polynomials(multivariate_d);
    //     auto libra_univariates = SumcheckProver<Flavor>::generate_libra_polynomials(multivariate_d);
    // }
};
