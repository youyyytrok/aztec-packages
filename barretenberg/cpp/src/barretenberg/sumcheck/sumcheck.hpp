...
polynomials that are sent in clear.
    ...
    void setup_zk_sumcheck_data(ZKSumcheckData& zk_sumcheck_data)
    {
        ...
        // Extract the evaluation masking scalars generated by Oink from the proving key.
        auto& eval_masking_scalars = proving_key.eval_masking_scalars;
        ...
        // Extract Libra univariates generated by Oink, they are used to mask Round Univariates.
        auto libra_univariates = proving_key.libra_univariates;
